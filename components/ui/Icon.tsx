...
const ICONS: Record<string, React.ReactNode> = {
  ...
  eyeOff: (<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M2 2l16 16"/><path d="M6.7 6.7A7.5 7.5 0 0 0 1.5 10s3.5 6 8.5 6c1.7 0 3.2-.5 4.5-1.4"/><path d="M9 4.1C9.3 4 9.6 4 10 4c5 0 8.5 6 8.5 6a14 14 0 0 1-1.9 2.8"/></svg>),
  logout: (<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M7.5 3H4.5A1.5 1.5 0 0 0 3 4.5v11A1.5 1.5 0 0 0 4.5 17H7.5"/><polyline points="13 14 17 10 13 6"/><line x1="17" y1="10" x2="7.5" y2="10"/></svg>),
  ...
  play: (<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><circle cx="10" cy="10" r="7.5"/><polygon points="8.5,7 14,10 8.5,13" fill="currentColor" stroke="none"/></svg>),
  hash: (<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><line x1="5" y1="7" x2="15" y2="7"/><line x1="4" y1="13" x2="14" y2="13"/><line x1="8" y1="3" x2="6" y2="17"/><line x1="14" y1="3" x2="12" y2="17"/></svg>),
